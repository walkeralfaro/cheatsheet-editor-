...
#### Scenario: Both fields show edit button on hover
- **WHEN** the user hovers over a shortcut table row
- **THEN** an edit button (✎) appears in both the keys column and the action column, with a subtle background highlight on the hovered cell
