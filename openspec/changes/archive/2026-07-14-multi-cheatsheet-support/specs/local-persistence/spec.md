...
**Reason**: Replaced by multi-cheatsheet create and delete actions in `cheatsheet-manager`
**Migration**: Use "New" button to create a fresh cheatsheet; use sidebar delete to remove unwanted cheatsheets
