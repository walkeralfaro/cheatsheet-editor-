...
The system SHALL allow the user to click on a shortcut rendered in the preview to edit its keys and action inline.
...
- **WHEN** the user edits an inline input and presses Enter
- **THEN** the shortcut is updated and the card returns to display mode
